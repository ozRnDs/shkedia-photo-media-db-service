...
class InsightServiceHandler:
    ...
    def __initialize_routes__(self):
        ...
        router.add_api_route(path="/engine", 
        ...
        router.add_api_route(path="/engine/mng/{engine_id}",
                             endpoint=self.get_engine,
                             methods=["get"],
                             response_model=Union[InsightEngine, InsightEngineBasic])
        router.add_api_route(path="/engine/all",
        ...
        router.add_api_route(path="/engine/{engine_id}",
                             endpoint=self.get_engine,
                             methods=["get"],
                             response_model=Union[InsightEngineBasic, None])
