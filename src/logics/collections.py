...
class CollectionLogicService:
    ...
    def get_collections_metadata_by_names(self,collections_names: List[str]) -> Dict[str,CollectionMedia]:
        ...
        sql_query=sql_query.where(insight_table.c.name.in_(collections_names))
        results_dict = {}
